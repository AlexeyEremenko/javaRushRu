...
//For Christ sent me not to baptize, but to preach the gospel: not with wisdom of words, lest the cross of Christ should be made of no effect. (1Cor 1:17)
...
public class Solution {
    ...
    public static class Rectangle{
        ...
        public HasHeight castToHasHeight() {
            class one implements HasHeight{
